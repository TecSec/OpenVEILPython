...
echo SETLOCAL ENABLEEXTENSIONS > mscleanrelease.cmd
echo for %%%%i in (release) do ( >> mscleanrelease.cmd
echo    for %%%%j in (vc12) do ( >> mscleanrelease.cmd
echo      for %%%%k in (x86 x64) do ( >> mscleanrelease.cmd
echo 		pushd vs%%%%i-%%%%j-%%%%k >> mscleanrelease.cmd
echo 		call cleanrelease.cmd >> mscleanrelease.cmd
echo 		popd >> mscleanrelease.cmd
echo 	 ) >> mscleanrelease.cmd
echo    ) >> mscleanrelease.cmd
echo ) >> mscleanrelease.cmd
